...
// React MDEditor를 동적 로딩 (SSR 이슈 방지)
const MDEditor = dynamic(
  () => import('@uiw/react-md-editor'),
  { 
    ssr: false,
    loading: () => (
      <div className="w-full h-[300px] border border-gray-300 rounded-lg flex items-center justify-center bg-gray-50">
        <div className="text-gray-500">마크다운 편집기를 불러오는 중...</div>
      </div>
    )
  }
)
